...
<div class="container-fluid">
    ...
    <div id="guestSlider" class="carousel slide" data-ride="carousel">
            ...
            foreach ($banner as $key) : ?>
                <?php if ($i == 1) : ?>
                    ...
                    <?php else : ?>
                        ...
                        <?php endif; ?>
                        <img src="<?= base_url('assets/img/slider/') . $key['img'] ?>" class="d-block w-100">
                        </div>
                    <?php $i++;
                    endforeach; ?>
                    </div>
        ...
        <div class="card bg-primary text-white text-center py-2 mb-4">
            <h5>SELF-SERVICE (PERKEMBANGAN INPUTAN DATA)</h5>
        </div>
        ...
        <form action="<?= base_url('guest/report') ?>" method="post">
            <?php if (!isset($_GET['produk'])) : ?>
                ...
                <a href="" class="my-2 btn btn-sm btn-primary shadow-sm show-kat">Show Category</a>
            <?php endif; ?>
