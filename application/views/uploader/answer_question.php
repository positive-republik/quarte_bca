...
<div class="form-group">
    <label for="answer">Answer</label>
    <textarea class="form-control" id="answer" name="answer" rows="5" required><?= $question['answer'] ?></textarea>
</div>
<div class="form-group">
    <label for="answer_link">Link</label>
    <input type="text" class="form-control" id="answer_link" name="answer_link" value="<?= $question['answer_link'] ?>" required>
</div>
<?php endif; ?>
